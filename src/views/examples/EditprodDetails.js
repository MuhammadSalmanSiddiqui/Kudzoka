...
class EditprodDetails extends React.Component {
    state = {};
    render() {
        return (
            <>
                                    ...
                                    <div className=" icon-examples">
                                        <Row>
                                            <Col style={{ width: 500, }} className="mb-5  lg='2' mb-xl-4" xl="6">
                                                <span style={{ fontSize: 20, fontWeight: "bold" }} className="text-darker ">Edit Product Category</span>
                                            </Col>
                                        ...
                                        <div className="container">
                                            <div className="row">
                                                ...
                                                <Col className="col-md-4">
                                                    ...
                                                    <div >
                                                        <span className="text-darker text-sm">Product Name </span>
                                                    </div>
                                                ...
                                                <Col className="col-md-4">
                                                    <div >
                                                        <span className="text-darker text-sm">Product Company</span>
                                                    </div>
...
export default EditprodDetails;
